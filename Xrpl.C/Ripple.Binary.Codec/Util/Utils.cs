...
namespace Ripple.Binary.Codec.Util
{
    ...
    public static class NFTokenID
    {
        public static string ParseNFTokenID(string nftokenID)
        {
            ...
            {
                throw new Exception($"Attempting to parse a nftokenID with length ${nftokenID.Length}\n" +
            ...
            string issuer = XrplCodec.EncodeAccountID(FromHexToBytes(nftokenID.Substring(8, 40)));
